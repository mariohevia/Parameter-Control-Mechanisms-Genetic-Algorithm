...
#ifndef LAMBDALAMBDARESET_H_
#define LAMBDALAMBDARESET_H_

#include "Optimizer.h"
#include "Util.h"

// Inherits and implements the Optimizer interface
class LambdaLambdaReset : public Optimizer {
 public:
  LambdaLambdaReset(Random& _rand, shared_ptr<Evaluator> _evaluator,
               Configuration& _config);
  virtual bool iterate() override;
  create_optimizer(LambdaLambdaReset);
