...
#ifndef LAMBDALAMBDARESETF_H_
#define LAMBDALAMBDARESETF_H_

#include "Optimizer.h"
#include "Util.h"

// Inherits and implements the Optimizer interface
class LambdaLambdaResetF : public Optimizer {
 public:
  LambdaLambdaResetF(Random& _rand, shared_ptr<Evaluator> _evaluator,
               Configuration& _config);
  virtual bool iterate() override;
  create_optimizer(LambdaLambdaResetF);
