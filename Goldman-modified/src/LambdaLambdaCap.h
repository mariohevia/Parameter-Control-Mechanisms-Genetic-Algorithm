...
#ifndef LAMBDALAMBDACAP_H_
#define LAMBDALAMBDACAP_H_

#include "Optimizer.h"
#include "Util.h"

// Inherits and implements the Optimizer interface
class LambdaLambdaCap : public Optimizer {
 public:
  LambdaLambdaCap(Random& _rand, shared_ptr<Evaluator> _evaluator,
               Configuration& _config);
  virtual bool iterate() override;
  create_optimizer(LambdaLambdaCap);
